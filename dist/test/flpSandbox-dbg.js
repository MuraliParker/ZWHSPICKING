		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comsapparkerzwmpicking-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsapparkerzwmpicking-display": {
								"semanticObject": "comsapparkerzwmpicking",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sap.parker.zwmpicking",
									"url": sap.ui.require.toUrl("com/sap/parker/zwmpicking")
								}
							}
						}
					}
